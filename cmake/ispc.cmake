...
LIST(GET ISPC_VERSION_WORKING -1 ISPC_VERSION_REQUIRED)
  ...
  IF (NOT ISPC_EXECUTABLE)
    MESSAGE(FATAL_ERROR "Intel SPMD Compiler (ISPC) not found. Disable ISPC_SUPPORT or install ISPC.")
  ELSE()
...
IF (NOT ${ISPC_RESULT} STREQUAL "0")
  MESSAGE(FATAL_ERROR "Error executing ISPC executable '${ISPC_EXECUTABLE}': ${ISPC_RESULT}")
ENDIF()
...
MACRO (ADD_ISPC_LIBRARY name type)
  ...
  ENDFOREACH()
  ISPC_COMPILE(${ISPC_SOURCES})
  ADD_LIBRARY(${name} STATIC ${ISPC_OBJECTS} ${OTHER_SOURCES})
ENDMACRO()