...
namespace tracer {
template <typename T> struct __attribute__((aligned(16))) vec4 {
...
template <typename T> struct __attribute__((aligned(16))) vec3 {
...
template <typename T> struct __attribute__((aligned(16))) vec2 {
